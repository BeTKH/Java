...
public class isGuth {
    ...
    public static int isGuthSeq(int[] list){
        ...
        int nextSequenceNumber = list[0];  // the first value of the Basics.Methods.Guth sequence

        if(list[list.length - 1] == 1){    // the last element of the Basics.Methods.Guth seq has to be 1 , else the if body is skipped and the flag above is unchanged
