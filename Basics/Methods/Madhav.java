...
public class Madhav{
    ...
    static int isMadhavArray(int[] listOfNumbers){
        ...
        int isMadhavArray = 0;  // let's say initially we believe the array is NOT Basics.Methods.Madhav Array
        int arrayLength = listOfNumbers.length;  // the whole length of our array

        /* THE CURRENT ARRAY :

        - refers to a small chunk of the big array being tested for Basics.Methods.Madhav conditions such as array[0] = array[1] + array[2]
        ...
        */
        ...
        while(currentLengthOfArray <= arrayLength){
            ...
            if(currentLengthOfArray == calculatedLengthOfArray){
                ...
                // Fail ::: The length of a Basics.Methods.Madhav array must be n*(n+1)/2 for some n
                isMadhavArray = 0;
                break;
            }
